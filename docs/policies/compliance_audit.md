...
description: Tessera may be requested occasionally to share additional details regarding
...
Tessera may be requested occasionally to share additional details regarding its
...
(a) Tessera operations must comply with all applicable laws,
...
conducted accordingly to each applicable compliance requirement.
  ...
  - HIPAA/HITECH. Tessera must comply with all requirements listed
...
under signed NDA and approved by Tessera Security and/or Privacy Officer.
...
Tessera management and security/compliance team has identified and
regularly reviews all relevant statutory, regulatory, and contractual
requirements.

Tessera's compliance policy includes requirements to meet any and
...
Tessera, at its sole discretion, shares audit reports, including
any Corrective Action Plans (CAPs) and exceptions, with customers on a case by case
basis. All audit reports are shared under explicit NDA in Tessera format
between Tessera and party to receive materials. Audit reports can be requested
by Tessera workforce members for Customers or directly by Tessera Customers.

The following process is used to request audit reports:

1. A request may be sent by email to
   [compliance@tessera.locoensayo.org](mailto:compliance@tessera.locoensayo.org)
   or by submitting a request via Tessera Internal Support Portal
   or Email. In the request, please specify the type of report being requested
   and any required timelines for the report.
2. An Issue with the details of the request into the Tessera Security Project
   on , which is used to track requests status and outcomes.
3. Tessera security team will confirm if a current NDA is in place with the
   party requesting the audit report. If there is no NDA in place, Tessera will
   send one for execution.
4. Once it has been confirmed that an NDA is executed, Tessera staff will move
   the  Issue to "Under Review".
5. The Tessera Security Officer or Privacy Officer must Approve or Reject the
   Issue. If the Issue is rejected, Tessera will notify the requesting party
   that we cannot share the requested report.
4. If the Issue has been Approved, Tessera will send the customer the requested
...
Prior to contracting with an external audit firm, Tessera shall:
...
* For privacy concerns, including report of violation:
    - [privacy@tessera.locoensayo.org](mailto:privacy@tessera.locoensayo.org)
    - <>
