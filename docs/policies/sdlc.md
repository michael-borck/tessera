...
- Secure Development
description: Tessera development team follows the latest security best practices
...
Tessera development team follows the latest security best practices when
developing software, and automates security testing throughout development
lifecycle whenever possible.

Security is integrated into all phases of Tessera product development lifecycle,
including:
...
Details about the Tessera software application architecture and
...
(a) Tessera software engineering and product development is required to follow
...
third-party components and dependencies included in Tessera software products.
...
Software development at Tessera follows a release strategy that provides
...
Tessera practices continuous delivery of code into production
...
Tessera’s multiple lower environments (dev, test) provide an ecosystem of
...
All Tessera `git` repositories have a company standard configuration from a
...
Tessera practices continuous delivery of code into production through multiple
...
Tessera development/engineering team uses  for
...
All Tessera software must be developed to include the following general
...
reported and tracked following Tessera Vulnerability Management process
...
Tessera Security Team in collaboration with development team performs full
...
Documentation on the Tessera [Engineering Wiki]()
may include additional security specifications as well as the security design
and implementation details of the Tessera Platform and its
...
Tessera external software application that is customer facing with
...
Tessera security and development team implemented a process to
...
-   The Lint and GitLeaks Platform - static and dynamic code analysis. Together with
    ...
    Tessera  pipeline library via the `securityScan()` step
...
Tessera uses a third party platform to maintain a public
...
Tessera's platform and its public facing resources.
...
Tessera requires all outsourced software development to follow the
...
associate" of ours.  It is required by HIPAA for Tessera and AWS to
...
details on Tessera's HIPAA compliance.
