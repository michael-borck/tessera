...
description: Tessera shall audit, monitor, and assess the access and activity of
...
Tessera shall audit, monitor, and assess the access and activity of
systems and applications that process or store production and/or sensitive data
...
capabilities and resources. Tessera shall make reasonable and
...
It is the policy of Tessera to safeguard the confidentiality, integrity, and
availability of applications, systems, and networks. To ensure that appropriate
safeguards are in place and effective, Tessera shall audit access and activity
...
This policy applies to all Tessera systems that store, transmit, or process
...
(c) An annual audit of Tessera security controls must be conducted, either by a
...
Tessera's auditing processes include the following.
...
2. **Access Review:** This refers to the review of all user and service accounts
   and permissions across Tessera operational environments, including
    ...
    * Tessera developed an internal tool to automatically pull configurations
...
3. **Compliance and Controls Audit:** This refers to the audit performed against
   ...
   Tessera policies and procedures, to measure their adoption and
...
* Responsibility for audit activity is assigned to Tessera's Security Officer.
  The Security Officer shall:
    ...
    * All connections to Tessera are monitored. Access is limited to certain
...
3. A request for an audit must be reviewed and approved by Tessera's Privacy
    ...
    * Should the audit disclose that a workforce member has accessed sensitive data
      ...
      be shared with Tessera's Security Officer to determine appropriate
    ...
    * Only de-identified information shall be shared with Customer or Partner
      ...
      will be communicated to the appropriate personnel by Tessera's Privacy
      Officer or designee. Prior to communicating with customers and partners
      regarding an audit, it is recommended that Tessera consider seeking
...
2. The reporting process shall allow for meaningful communication of the audit
    ...
    * Significant findings shall be reported immediately in a written format.
      Tessera's security incident response form may be utilised to report a
      single event.
...
4. Security audits constitute an internal, confidential monitoring practice that
   may be included in Tessera's performance improvement activities and
...
Tessera logging standards requires application and system logs to contain
...
All systems and software developed at Tessera must have the following security
...
5. All Tessera IT infrastructure must have system clock synchronised
...
3. Whenever possible, audit logs shall be stored on a separate system to
    ...
    * Tessera logging servers may include Elasticsearch, Logstash, and Kibana
...
1. Periodic monitoring of Customer and Partner activity shall be carried out to
   ...
   necessary to the arrangement between Tessera and the 3rd party.
   Tessera will make every effort to assure Customers and Partners
...
1. If it is determined that the Customer or Partner has exceeded the scope of
   access privileges, Tessera's management and security must remedy
...
1. If it is determined that a Customer or Partner has violated the terms of the
   ...
   Tessera must take immediate action to remediate the situation. Continued
   violations may result in discontinuation of the business relationship.


### Auditing and Assessment Tools

Tessera's Security Officer is authorised to select and use assessment tools
that are designed to detect vulnerabilities and intrusions. Use of such tools
against Tessera systems and environments are prohibited by others, including
...
1. Tessera workforce members are provided training, education, and
   awareness on safeguarding the privacy and security of business and data.
   Tessera's commitment to auditing access and activity of the
   ...
   applicable policies. Tessera workforce members are made aware of
...
2. Tessera Customers are provided with necessary information to understand
   Tessera auditing capabilities. Platform Customers are responsible for the
   logging, auditing and retention of any application hosted outside of Tessera
   environments, even though the applications may integrate with Tessera
   Platform API.  Customer applications hosted within the Tessera environments
