...
Security and compliance is everyone's responsibility.  Tessera is committed to
...
managers and executives at Tessera.
...
oversight of all activities pertaining to Tessera's efforts to be compliant
...
Tessera has appointed Sec Urity as the Security Officer and Pri Vact as the
Privacy Officer.
...
workforce members are required to:
  ...
  * Follow all security requirements set forth in Tessera security
...
(c) All workforce members are required to report non-compliance of Tessera's
...
Tessera has appointed Sec Urity as the Security
...
The authority and accountability for Tessera’s information
...
workforce members and any other user of Tessera's systems, applications,
...
3. Take all reasonable steps to hire, retain, and promote workforce members and
   ...
   Tessera's security policies and procedures.

#### Segregation of Duties

Tessera has dedicated team/personnel assigned the job
...
3. The training session focuses on, but is not limited to, the following
   subjects defined in Tessera's security policies and procedures:

    1. SOC 2 Security Principals and Controls;
    1. HIPAA Privacy, Security, and Breach notification rules;
    1. Risk Management procedures and documentation;
    1. Auditing. Tessera may monitor access and activities of all users;
    1. Workstations may only be used to perform assigned job responsibilities;
    1. Users may not download software onto Tessera's workstations
    ...
    of Tessera's systems and/or workstations;
    ...
    do so by a Tessera Customer;
    1. Users are required to understand their role in Tessera's contingency
    plan;
...
Tessera leverages KnowBe4 to deliver innovative, fun and
...
Tessera requires all employees to take a HIPAA awareness training
...
Tessera holds a company-wide roundtable at least quarterly to
