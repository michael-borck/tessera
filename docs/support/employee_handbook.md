...
- Training
- Security Awareness
description: This is an abridged version of Tessera's security policy that all workforce members are required to be familiar with and comply with.
...
This is an abridged version of Tessera's security policy that all
...
* First and foremost, as a Health IT provider, Tessera and all
...
doubt, stop and ask.
    ...
    As a Tessera employee, I acknowledge that
...
(a) Per Tessera [security architecture](../policies/model.md), all workforce
...
(j) Mobile devices are not allowed to connect directly to Tessera production
environments.
...
Tessera file sharing / team site (e.g. SharePoint). Examples of
...
* (preferred) “Report a security incident” by creating an issue on
   and/or via the
  [internal help desk](](mailto:security@tessera.locoensayo.org)

* For non-sensitive, non-confidential security issues and concerns, employees
  may post questions on Tessera’s #infosec Slack channel.
