...
- Compliance
- Risk Management
description: Tessera is a cloud hosting and managed IT services provider founded in 2010 and headquartered in Perth, Western Australia.
...
Tessera is a cloud hosting and managed IT services provider founded
...
infrastructure for over 500 business customers. Tessera has around 200
...
24/7 monitoring for client infrastructure hosted in the Tessera data centers.
Tessera's executive leadership includes:
...
data backup and virtual desktop services. Tessera handles sensitive customer
...
1.  **Scope and Context:** The ISMS starts by defining its scope, which could be
    ...
    achieving business objectives. Tessera would establish its ISMS
...
2.  **Risk Assessment:** This involves identifying the assets, threats,
    vulnerabilities, impacts, and the likelihood of occurrence to calculate the
    risk. Tessera would need to assess all its IT systems, hardware,
...
5.  **Security Policies and Procedures:** Tessera would need to
...
8.  **Regular Audits and Review:** Tessera would need to conduct
...
The scope of Tessera' ISMS encompasses the entirety of the
...
infrastructure hosted in the Tessera data centers.
...
that can influence the performance of Tessera' ISMS.
...
_External Context_: Tessera, being based in Perth, Australia,
...
which govern how personal information is handled. If Tessera handles
...
in the IT sector, Tessera faces an evolving threat landscape with
potential cybersecurity threats from a variety of sources.

_Stakeholders_: The primary stakeholders for Tessera' ISMS are its
customers, employees, and shareholders. Customers trust Tessera to
...
By defining the scope and context, Tessera can ensure that its ISMS
...
exposure of the organisation's assets. For Tessera, the risk
...
*   Intangible Assets: Tessera' reputation, brand value, customer
    trust.
...
identified, Tessera would need to evaluate the risk. This involves
...
For example, a DDoS attack on Tessera's servers might have a high impact,
...
Tessera must keep its risk assessment updated to maintain the
...
In the case of Tessera, the risk treatment process would involve the
following steps:
...
*   **Risk Avoidance:** This involves not performing an activity that could
    ...
    serious threat to the network, Tessera might avoid using it
    altogether.
...
*   **Risk Transfer:** This means handing over the risk to a third party,
    typically an insurer. Tessera could have insurance to cover the
...
In the case of Tessera, we use a combination of these
...
Tessera could conduct periodic testing or auditing of its controls,
...
evolves with the changing risk landscape and business context. Tessera
...
In the case of Tessera, the Information Security Objectives include:

**1. Ensuring Confidentiality, Integrity, and Availability (CIA) of Information:** 
As a cloud hosting and managed IT service provider, Tessera
...
Australia, Tessera needs to comply with the Australian Privacy
...
**3. Continual Improvement of the ISMS:** Tessera should strive for
...
a significant security risk, Tessera should aim to enhance employee
...
trust is crucial for Tessera. An objective could be to maintain or
...
The security policies and procedures are the cornerstone of Tessera'
...
parties who have access to Tessera' systems and data. This includes
...
Through these policies and procedures, Tessera seeks to create a
...
responsibilities in protecting Tessera' information assets. By
...
The Training and Awareness program applies to all personnel within Tessera
...
By investing in security training and awareness, Tessera seeks to
...
repeatable process for handling information security incidents at Tessera
...
Tessera' systems or data. This includes cyber attacks such as malware
...
The Incident Management process is a crucial part of Tessera'
...
effectiveness and efficiency of Tessera' Information Security
...
Tessera, is responsible for conducting internal audits. External
...
Tessera also contracts an external auditor annually to conduct a
...
improving the ISMS of Tessera. By actively seeking out areas of
...
The purpose of the Continuous Improvement process is to ensure that Tessera
...
every team member within Tessera contributes to the process through
...
robust ISMS. It enables Tessera to stay proactive in the face of an
