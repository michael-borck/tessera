...
- Device Security
- Data Protection
description: Tessera recognises that media containing sensitive data may be reused
...
Tessera recognises that media containing sensitive data may be reused when
...
Tessera utilises virtual storage repositories such as AWS EBS volumes and S3
buckets to store production data.  Volumes and repositories utilised by
Tessera and Tessera Customers are encrypted. Tessera does not use, own, or
...
(a) All media, including mobile and removable media, storing Tessera company
data must be encrypted.

(b) Critical data as defined in [Tessera data classification model
...
Tessera's written retention policy/schedule.
...
* All Tessera Subcontractors provide that, upon termination of the contract,
...
*  In the cases of a Tessera Customer terminating a contract with
   Tessera and no longer utilise Tessera Services,
   data will be returned or disposed per contract agreement or
   Tessera Platform use terms and conditions. In all cases it is
   solely the responsibility of the Tessera Customer to maintain
   the safeguards required of laws and regulations once the data is transmitted
   out of Tessera environments.


### Use of USB Flash Drive and External Storage Device

Per Tessera corporate policy, confidential and critical data may
...
Tessera Data Classification and Handling Policy.
...
*   Data is only allowed on encrypted flash devices approved by Tessera
...
Tessera provides company-issued laptops and workstations to all employees.



Tessera currently does not require or support employees bringing their own
computing devices.

The end-user computing devices are self managed. Each Tessera employee is
responsible to
