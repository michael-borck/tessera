...
- IT Management
- Risk Assessment
description: 'Policy Statements  Tessera policy requires that:  (a) All product
...
2. Additionally, periodic security scans of Tessera on-premise systems are done
...
3. Penetration testing is performed regularly as part of the Tessera
    ...
    * Additional external penetration testing is performed at least annually by
      either a certified penetration tester on Tessera security team or an
      independent third party.
    * White-box internal penetration testing is performed at least quarterly by
      the security team.

4. Tessera developed an internal vulnerability management tool/database used to
